...
// Nashorn ~ JDK8 bug
var NASHORN_BUG =
  getOwnPropertyDescriptor$1 && !nativePropertyIsEnumerable.call({ 1: 2 }, 1);
  ...
  methods: _objectSpread2(
    {
      _initTable: function _initTable() {
        var options = _objectSpread2(
          _objectSpread2({}, deepCopy(this.options)),
          {},
          {
      ...
      try {
        var _loop = function _loop() {
          ...
          res[method] = function () {
            ...
            return (_this$$table = this.$table).bootstrapTable.apply(
              _this$$table,
              [method].concat(args)
            );
          };
